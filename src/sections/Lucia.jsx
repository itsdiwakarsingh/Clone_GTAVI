...
const Lucia = () => {
  ...
  return (
    <section className="lucia-life">
      <div className="flex flex-col gap-5 items-end img-box lg:1/2 lg:1/2 ps-10 mt-96">
      ...
      <div className="lg:w-1/2 lucia-life-content">
        <div className="max-w-lg lucia-content ps-10">
          <h1>Lucia Caminos</h1>
          ...
          <p>
            ...
            family landed her in Leonida Penitentiary. Sheer luck got her out.
        ...
        <p className="max-w-xl lg:ps-32 ps-10">
          ...
          since their days in Liberty City - but insted of half-baked fantasies,
          Lucia is prepared to take matter into her hands.
        </p>
      </div>
    </section>
  );
